# Importa el módulo 'math' que proporciona acceso a funciones matemáticas.
import math
...
class Client(Thread):
    ...
    def run(self):
        ...
        # Realiza el cálculo del logaritmo de num1 en la base num2.
        suma = math.log(int(num1), int(num2))
        print("Dato enviado: ", suma)

        # Envía el resultado del cálculo al cliente, codificándolo en UTF-8.
...
def main():
    ...
    # Crea una cadena con la dirección IP y el puerto del servidor de logaritmación.
