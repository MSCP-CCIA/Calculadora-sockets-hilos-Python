...
class Client(Thread):
    ...
    def run(self):
        ...
        # Realiza la resta de los números convertidos a enteros.
        suma = int(num1) - int(num2)
        print("Dato enviado: ", suma)

        # Envía el resultado de la resta al cliente, codificándolo en UTF-8.
...
def main():
    ...
    # Crea una cadena con la dirección IP y el puerto del servidor de resta.
