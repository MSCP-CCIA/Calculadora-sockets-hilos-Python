# Importa el módulo 'math', que proporciona acceso a funciones matemáticas. No se utiliza en este código.
import math
...
class Client(Thread):
    ...
    def run(self):
        ...
        # Realiza la división de los números convertidos a enteros.
        suma = int(num1) / int(num2)
        print("Dato enviado: ", suma)

        # Envía el resultado de la división al cliente, codificándolo en UTF-8.
...
def main():
    ...
    # Crea una cadena con la dirección IP y el puerto del servidor de división.
